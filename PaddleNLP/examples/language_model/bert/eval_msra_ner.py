...
def do_train(args):
    ...
    test_dataset = ppnlp.datasets.MSRA_NER.get_datasets(["test"])
    ...
    metric = ChunkEvaluator(label_list=test_dataset.get_labels())
    evaluate(model, metric, test_data_loader, label_num)
